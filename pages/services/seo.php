            ...
            <div class="row">
            	<div class="col-lg-12 col-md-12 col-sm-12">
            		<div class="input-group">
            			<input class="form-control input-lg input-border" type="text" placeholder="Go ahead, Google yourself.">
            			<span class="input-group-btn"><button class="btn btn-lg btn-primary">Search</button></span>
            		</div>
            	</div>
            </div>
            <div class="row">
